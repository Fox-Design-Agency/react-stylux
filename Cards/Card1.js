...
var Card1 = function (_Component) {
    _inherits(Card1, _Component);

    function Card1(props) {
        _classCallCheck(this, Card1);

        var _this = _possibleConstructorReturn(this, (Card1.__proto__ || Object.getPrototypeOf(Card1)).call(this, props));
