            ...
            case "1":
                switch (this.state.vars) {
                    case "1":
                        ...
                        styledHeading = [
                            <MediaQuery key={tempkeys[0]} query="(min-width: 1224px)"><h1 style={use.heading} id={this.state.id} className={this.state.className}
            ...
            case "2":
                switch (this.state.vars) {
                    case "1":
                        ...
                        styledHeading = [
                            <MediaQuery key={tempkeys[0]} query="(min-width: 1224px)"><h2 style={use.heading} id={this.state.id} className={this.state.className}
                                onMouseEnter={() => this.setState({ color: use.hoverStyle.color })}
            ...
            case "3":
                switch (this.state.vars) {
                    case "1":
                        ...
                        styledHeading = [
                            <MediaQuery key={tempkeys[0]} query="(min-width: 1224px)"><h3 style={use.heading} id={this.state.id} className={this.state.className}
                                onMouseEnter={() => this.setState({ color: use.hoverStyle.color })}
            ...
            case "4":
                ...
                switch (this.state.vars) {
                    case "1":
                        ...
                        styledHeading = [
                            <MediaQuery key={tempkeys[0]} query="(min-width: 1224px)"><h4 style={use.heading} id={this.state.id} className={this.state.className}
                                onMouseEnter={() => this.setState({ color: use.hoverStyle.color })}
            ...
            case "5":
                switch (this.state.vars) {
                    case "1":
                        ...
                        styledHeading = [
                            <MediaQuery key={tempkeys[0]} query="(min-width: 1224px)"><h5 style={use.heading} id={this.state.id} className={this.state.className}
                                onMouseEnter={() => this.setState({ color: use.hoverStyle.color })}
            ...
            case "6":
                switch (this.state.vars) {
                    case "1":
                        ...
                        styledHeading = [
                            <MediaQuery key={tempkeys[0]} query="(min-width: 1224px)"><h6 style={use.heading} id={this.state.id} className={this.state.className}
                                onMouseEnter={() => this.setState({ color: use.hoverStyle.color })}
            ...
            case "1":
                switch (this.state.vars) {
                    case "1":
                        use = heading1Function("1", props, state, self)
                        styledHeading = [
                            <MediaQuery key={this.state.keys[0]} query="(min-width: 1224px)"><h1 style={use.heading} id={this.state.id} className={this.state.className}
                                onMouseEnter={() => this.setState({ color: use.hoverStyle.color })}
                                onMouseLeave={() => this.setState({ color: this.state.colorRev })}>{CHILDS}</h1></MediaQuery>,
            ...
            case "2":
                switch (this.state.vars) {
                    case "1":
                        use = heading2Function("1", props, state, self)
                        styledHeading = [
                            <MediaQuery key={this.state.keys[0]} query="(min-width: 1224px)"><h2 style={use.heading} id={this.state.id} className={this.state.className}
                                onMouseEnter={() => this.setState({ color: use.hoverStyle.color })}
                                onMouseLeave={() => this.setState({ color: this.state.colorRev })}>{CHILDS}</h2></MediaQuery>,
            ...
            case "3":
                switch (this.state.vars) {
                    case "1":
                        use = heading3Function("1", props, state, self)
                        styledHeading = [
                            <MediaQuery key={this.state.keys[0]} query="(min-width: 1224px)"><h3 style={use.heading} id={this.state.id} className={this.state.className}
                                onMouseEnter={() => this.setState({ color: use.hoverStyle.color })}
                                onMouseLeave={() => this.setState({ color: this.state.colorRev })}>{CHILDS}</h3></MediaQuery>,
            ...
            case "4":
                ...
                switch (this.state.vars) {
                    case "1":
                        use = heading4Function("1", props, state, self)
                        styledHeading = [
                            <MediaQuery key={this.state.keys[0]} query="(min-width: 1224px)"><h4 style={use.heading} id={this.state.id} className={this.state.className}
                                onMouseEnter={() => this.setState({ color: use.hoverStyle.color })}
                                onMouseLeave={() => this.setState({ color: this.state.colorRev })}>{CHILDS}</h4></MediaQuery>,
            ...
            case "5":
                switch (this.state.vars) {
                    case "1":
                        use = heading5Function("1", props, state, self)
                        styledHeading = [
                            <MediaQuery key={this.state.keys[0]} query="(min-width: 1224px)"><h5 style={use.heading} id={this.state.id} className={this.state.className}
                                onMouseEnter={() => this.setState({ color: use.hoverStyle.color })}
                                onMouseLeave={() => this.setState({ color: this.state.colorRev })}>{CHILDS}</h5></MediaQuery>,
            ...
            case "6":
                switch (this.state.vars) {
                    case "1":
                        use = heading6Function("1", props, state, self)
                        styledHeading = [
                            <MediaQuery key={this.state.keys[0]} query="(min-width: 1224px)"><h6 style={use.heading} id={this.state.id} className={this.state.className}
                                onMouseEnter={() => this.setState({ color: use.hoverStyle.color })}
                                onMouseLeave={() => this.setState({ color: this.state.colorRev })}>{CHILDS}</h6></MediaQuery>,
