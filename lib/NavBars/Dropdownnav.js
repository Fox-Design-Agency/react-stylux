            ...
            case "1":
                switch (this.state.vars) {
                    case "1":
                        ...
                        FIRST = CHILDS[0];
                        styledDropdown = [
                            <MediaQuery key={tempkeys[0]} query="(min-width: 1224px)"><nav id={this.state.mainid} className={`dropdownnav1 ${this.state.mainClassName}`}>
            ...
            case "1":
                switch (this.state.vars) {
                    case "1":
                        ...
                        FIRST = CHILDS[0];
                        styledDropdown = [
                            <MediaQuery key={this.state.keys[0]} query="(min-width: 1224px)"><nav id={this.state.mainid} className={`dropdownnav1 ${this.state.mainClassName}`}>
                                <li id={this.state.titleid} className={`DropDown ${this.state.titleClassName}`} style={use.HASCHILDS}
                                    onMouseOver={() => this.enter()}
                                    onMouseOut={() => this.left()}>
                                    {FIRST}
