            ...
            case "1":
                switch (this.state.vars) {
                    case "1":
                        ...
                        styledSubnavbar = [
                            <MediaQuery key={tempkeys[0]} query="(min-width: 1224px)"><nav style={use.subnavbar} id={this.state.navid} className={`subnavbar1 socialness ${this.state.navClassName}`}>
            ...
            case "1":
                switch (this.state.vars) {
                    case "1":
                        ...
                        use = subnavbarFunction("1", props, state, self)
                        styledSubnavbar = [
                            <MediaQuery key={this.state.keys[0]} query="(min-width: 1224px)"><nav style={use.subnavbar} id={this.state.navid} className={`subnavbar1 socialness ${this.state.navClassName}`}>
                                <ul style={use.subnavbar_navbar} id={this.state.listid} className={`subnavbar1-navbar ${this.state.listClassName}`}>
                                    {NAVBAR}
                                </ul>
                            </nav></MediaQuery>,
