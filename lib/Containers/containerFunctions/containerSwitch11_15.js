...
export default function containerSwitch11_15(num, props, state) {
    let blocks, holderstyles, block1styles, block2styles, block3styles, block4styles, block5styles, block6styles, block7styles, block8styles, block9styles, block10styles, block11styles, block12styles, block13styles, block14styles, block15styles = '';
    switch (num) {
        case (num = 11):
            blocks = {
