            ...
            case '1':
                switch (this.state.vars) {
                    case "1":
                        ...
                        styledTable = [
                            <MediaQuery key={this.state.keys[0]} minWidth={1224}><div style={use.tableres} id={this.state.id} className={this.state.className} >
                            ...
                            <MediaQuery key={this.state.keys[1]} minWidth={768} maxWidth={1223}><div style={use.mdtableres} id={this.state.id} className={this.state.className} >
                            ...
                            <MediaQuery key={this.state.keys[2]} maxWidth={767}><div style={use.smtableres} id={this.state.id} className={this.state.className} >
