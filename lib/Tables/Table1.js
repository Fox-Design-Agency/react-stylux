...
export default class Table1 extends Component {
    ...
    const TABLERES = StyleSheet.create({
       tableres: {
            overflowX: 'auto',
        },
        '@media screen and (max-width: 768px)': {
        ...
        return (
            <div style={TABLERES.tableres} id={this.state.mainId} className={this.state.mainClassName}>
                <table style={TABLESTYLE.tablestyle} id={this.state.tableId} className={`${this.state.tableClassName}`}>
                    <thead>
                        {this.state.head}
                    </thead>
                    <tbody>
