...
import holderSwitch5 from "./holderFunctions/holderSwitch21-25";
import holderSwitch6 from "./holderFunctions/holderSwitch26-30";
import holderSwitch7 from "./holderFunctions/holderSwitch31-35";
import holderSwitch8 from "./holderFunctions/holderSwitch36-40";
import holderSwitch9 from "./holderFunctions/holderSwitch41-45";
import holderSwitch10 from "./holderFunctions/holderSwitch46-50";
...
export default class Holder extends Component {
    ...
    componentDidMount() {
        ...
        if (num === 1) {
            ...
            styledChilds19 = <div key={Math.random()} style={use.block19styles.block19styles}>{CHILDS[18]}</div>
            styledChilds20 = <div key={Math.random()} style={use.block20styles.block20styles}>{CHILDS[19]}</div>
            styledChilds21 = <div key={Math.random()} style={use.block20styles.block20styles}>{CHILDS[20]}</div>
            styledHolder = [
            ...
            styledChilds20 = <div key={Math.random()} style={use.block20styles.block20styles}>{CHILDS[19]}</div>
            styledChilds21 = <div key={Math.random()} style={use.block20styles.block20styles}>{CHILDS[20]}</div>
            styledChilds21 = <div key={Math.random()} style={use.block20styles.block20styles}>{CHILDS[21]}</div>
            styledHolder = [
            ...
            styledChilds21 = <div key={Math.random()} style={use.block20styles.block20styles}>{CHILDS[20]}</div>
            styledChilds21 = <div key={Math.random()} style={use.block20styles.block20styles}>{CHILDS[21]}</div>
            styledChilds21 = <div key={Math.random()} style={use.block20styles.block20styles}>{CHILDS[22]}</div>
            styledHolder = [
            ...
            styledChilds21 = <div key={Math.random()} style={use.block20styles.block20styles}>{CHILDS[21]}</div>
            styledChilds21 = <div key={Math.random()} style={use.block20styles.block20styles}>{CHILDS[22]}</div>
            styledChilds21 = <div key={Math.random()} style={use.block20styles.block20styles}>{CHILDS[23]}</div>
            styledHolder = [
