...
export default function containerSwitch46_50(num, props, state) {
    let blocks = '';
    ...
    switch (num) {
        case (num = 46):
            blocks = {
                ...
                block46Direction: props.block46direction || 'column',
        ...
        case (num = 47):
            blocks = {
                ...
                block46smdis: props.block46smdis || 'flex',
                block46mddis: props.block46mddis || 'flex',
                block47Direction: props.block47direction || 'column',
        ...
        case (num = 48):
            blocks = {
                ...
                block47smdis: props.block47smdis || 'flex',
                block47mddis: props.block47mddis || 'flex',
                block48Direction: props.block48direction || 'column',
        ...
        case (num = 49):
            blocks = {
                ...
                block48smdis: props.block48smdis || 'flex',
                block48mddis: props.block48mddis || 'flex',
                block49Direction: props.block49direction || 'column',
        ...
        case (num = 50):
            blocks = {
                ...
                block49smdis: props.block49smdis || 'flex',
                block49mddis: props.block49mddis || 'flex',
                block50Direction: props.block50direction || 'column',
