export default function wrapperSwitch46_50(num, props, state, themer) {
    let blocks = '';
    let background = props.background || props.themes ? props.themes.background : themer.background
