    ...
    componentDidMount() {
        ...
        if (this.state.box === "1") {
            ...
            const LIST = listItems.map((x, i) => {
                return (
                    <li key={i} style={use.LISTSTYLE.listitemstyle}>{x}</li>
                )
            })
            styledList = [
                <ul style={use.LISTSTYLE.liststyle} id={this.state.id} className={this.state.className}>
                    {LIST}
                </ul>
            ]
            ...
            styledList = [
                <ol style={use.LISTSTYLE.liststyle} id={this.state.id} className={`bigList ${this.state.className}`}>
                    {LIST}
                </ol>
            ]
            ...
            styledList = [
                <ol style={use.LISTSTYLE.liststyle} id={this.state.id} className={this.state.className}>
                    {LIST}
                </ol>
            ]
