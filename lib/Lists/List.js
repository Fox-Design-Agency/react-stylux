        ...
        switch (this.state.box) {
            case "1":
                switch (this.state.vars) {
                    case "1":
                        ...
                        styledList = [
                            <MediaQuery key={tempkeys[0]} query="(min-width: 1224px)"><ul style={use.liststyle} id={this.state.id} className={this.state.className}>
                                {LIST}
                            </ul></MediaQuery>,
            ...
            case "2":
                switch (this.state.vars) {
                    case "1":
                        ...
                        styledList = [
                            <MediaQuery key={tempkeys[0]} query="(min-width: 1224px)"><ol style={use.liststyle} id={this.state.id} className={`bigList ${this.state.className}`}>
                                {LIST}
                            </ol></MediaQuery>,
            ...
            case "3":
                switch (this.state.vars) {
                    case "1":
                        ...
                        styledList = [
                            <MediaQuery key={tempkeys[0]} query="(min-width: 1224px)"><ol style={use.liststyle} id={this.state.id} className={this.state.className}>
                                {LIST}
                            </ol></MediaQuery>,
            ...
            default:
                ...
                styledList = [
                    ...
                    <MediaQuery key={tempkeys[1]} query="(min-width: 1224px)"><ol style={use.liststyle} id={this.state.id} className={this.state.className}>
                        {LIST}
                    </ol></MediaQuery>,
                    <MediaQuery key={tempkeys[2]} query="(min-width: 1224px)"><ol style={use.liststyle} id={this.state.id} className={this.state.className}>
                        {LIST}
                    </ol></MediaQuery>
                ]
        }
        ...
        switch (this.state.box) {
            case "1":
                switch (this.state.vars) {
                    case "1":
                        ...
                        styledList = [
                            <MediaQuery key={this.state.keys[0]} query="(min-width: 1224px)"><ul style={use.liststyle} id={this.state.id} className={this.state.className}>
                                {LIST}
                            </ul></MediaQuery>,
            ...
            case "2":
                switch (this.state.vars) {
                    case "1":
                        ...
                        styledList = [
                            <MediaQuery key={this.state.keys[0]} query="(min-width: 1224px)"><ol style={use.liststyle} id={this.state.id} className={`bigList ${this.state.className}`}>
                                {LIST}
                            </ol></MediaQuery>,
            ...
            case "3":
                switch (this.state.vars) {
                    case "1":
                        ...
                        styledList = [
                            <MediaQuery key={this.state.keys[0]} query="(min-width: 1224px)"><ol style={use.liststyle} id={this.state.id} className={this.state.className}>
                                {LIST}
                            </ol></MediaQuery>,
            ...
            default:
                ...
                styledList = [
                    ...
                    <MediaQuery key={this.state.keys[1]} query="(min-width: 1224px)"><ol style={use.liststyle} id={this.state.id} className={this.state.className}>
                        {LIST}
                    </ol></MediaQuery>,
                    <MediaQuery key={this.state.keys[2]} query="(min-width: 1224px)"><ol style={use.liststyle} id={this.state.id} className={this.state.className}>
                        {LIST}
                    </ol></MediaQuery>
                ]
        }
