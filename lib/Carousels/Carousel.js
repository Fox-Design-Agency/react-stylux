            ...
            case "1":
                switch (this.state.vars) {
                    case "1":
                        ...
                        styledCarousel = [
                            <MediaQuery key={tempKeys[0]} minWidth={1224}><div style={use.WRAP} id={this.state.id} className={this.state.className}
                            >
            ...
            case "2":
                switch (this.state.vars) {
                    case "1":
                        ...
                        styledCarousel = [
                            <MediaQuery key={tempKeys[0]} minWidth={1224}>
            ...
            case "1":
                switch (this.state.vars) {
                    case "1":
                        ...
                        styledCarousel = [
                            <MediaQuery key={this.state.keys[0]} minWidth={1224}><div style={use.WRAP} id={this.state.id} className={this.state.className}
                            >
                                <div style={use.LEFT_ARROW} id={this.state.leftArrowid} className={`arrow ${this.state.leftArrowClassName}`} onClick={() => this.slideLeft()}></div>
                                <div style={use.SLIDER}>
                                    {RENDERSLIDES[this.state.cur]}
            ...
            case "2":
                switch (this.state.vars) {
                    case "1":
                        ...
                        styledCarousel = [
                            <MediaQuery key={this.state.keys[0]} minWidth={1224}>
                                <div style={use.WRAP} id={this.state.id} className={this.state.className}>
                                    <div style={use.SLIDER}>
                                        {RENDERSLIDES[this.state.cur]}
                                    </div>
