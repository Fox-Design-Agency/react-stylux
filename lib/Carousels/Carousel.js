...
export default class Carousel extends React.Component {
    ...
    componentDidMount() {
        ...
        if (this.state.box === "1") {
            ...
            styledCarousel = [
                <div key={tempKeys[0]} style={use.WRAP} id={this.state.id} className={this.state.className}
                >
    ...
    slideLeft() {
        ...
        if (this.state.cur === 0) {
            if (this.state.box === "1") {
                use = carouselFunction("1", props, state, self);
                styledCarousel = [
                    <div key={this.state.keys[0]} style={use.WRAP} id={this.state.id} className={this.state.className}
                    >
                        <div style={use.LEFT_ARROW} id={this.state.leftArrowid} className={`arrow ${this.state.leftArrowClassName}`} onClick={() => this.slideLeft()}></div>
                        <div style={use.SLIDER}>
