            ...
            case "1":
                switch (this.state.vars) {
                    case "1":
                        ...
                        styledPopup = [
                            <MediaQuery key={this.state.keys[0]} query="(min-width: 1224px)"><div style={use.POPUPCLICK} onClick={this.toggle}>
                                {this.state.childs[0]}
            ...
            case "2":
                switch (this.state.vars) {
                    case "1":
                        ...
                        styledPopup = [
                            <MediaQuery key={this.state.keys[0]} query="(min-width: 1224px)"><div style={use.POPUPCLICK}
            ...
            case "1":
                switch (this.state.vars) {
                    case "1":
                        ...
                        styledPopup = [
                            <MediaQuery key={tempkeys[0]} query="(min-width: 1224px)"><div style={use.POPUPCLICK} onClick={this.toggle}>
                                {CHILDS[0]}
                                <div style={use.POPUPSTYLE}>
                                    {CHILDS[1]}
                                </div>
            ...
            case "2":
                switch (this.state.vars) {
                    case "1":
                        ...
                        styledPopup = [
                            <MediaQuery key={tempkeys[0]} query="(min-width: 1224px)"><div style={use.POPUPCLICK}
                                onMouseEnter={this.toggle}
                                onMouseLeave={this.toggle}>
                                {CHILDS[0]}
                                <div style={use.POPUPSTYLE}>
