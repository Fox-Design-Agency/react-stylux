            ...
            case "2":
                switch (this.state.vars) {
                    case "1":
                        ...
                        styledToggler = [
                            <MediaQuery key={tempkeys[0]} minWidth={1224}><div id={this.state.id} style={use.FULLELEMENT} className={this.state.className}>
                                <div style={use.CLICKBOX} onClick={this.toggle}>
                                    {first}
                                </div>
                                <div style={use.TOGGLERBOX}>
            ...
            case "3":
                switch (this.state.vars) {
                    case "1":
                        ...
                        styledToggler = [
                            <MediaQuery key={tempkeys[0]} minWidth={1224}><div style={use.PANELS} id={this.state.mainid} className={`panels ${this.state.mainClassName}`}>
                                {CHECKS}
            ...
            case "4":
                switch (this.state.vars) {
                    case "1":
                        ...
                        styledToggler = [
                            <MediaQuery key={tempkeys[0]} minWidth={1224}><div style={use.PANELS} id={this.state.mainid} className={`vpanels ${this.state.mainClassName}`}>
                                {CHECKS}
            ...
            case "2":
                switch (this.state.vars) {
                    case "1":
                        ...
                        use = togglerFunction("2", props, state, self)
                        styledToggler = [
                            <MediaQuery key={this.state.keys[0]} minWidth={1224}><div id={this.state.id} style={use.FULLELEMENT} className={this.state.className}>
                                <div style={use.CLICKBOX} onClick={this.toggle}>
                                    {first}
                                </div>
                                <div style={use.TOGGLERBOX}>
            ...
            case "3":
                switch (this.state.vars) {
                    case "1":
                        ...
                        styledToggler = [
                            <MediaQuery key={this.state.keys[0]} minWidth={1224}><div style={use.PANELS} id={this.state.mainid} className={`panels ${this.state.mainClassName}`}>
                                {CHECKS}
                                <nav id={this.state.toggleid} className={this.state.toggleClassName}>
                                    {LABELS}
                                </nav>
            ...
            case "4":
                switch (this.state.vars) {
                    case "1":
                        ...
                        styledToggler = [
                            <MediaQuery key={this.state.keys[0]} minWidth={1224}><div style={use.PANELS} id={this.state.mainid} className={`vpanels ${this.state.mainClassName}`}>
                                {CHECKS}
                                <nav style={use.LABELTITLES} id={this.state.toggleid} className={this.state.toggleClassName}>
                                    {LABELS}
                                </nav>
            ...
            case "1":
                switch (this.state.vars) {
                    case "1":
                        ...
                        styledToggler = [
                            <MediaQuery key={this.state.keys[0]} minWidth={1224}><div key={this.state.keys[0]} id={this.state.mainid} className={this.state.mainClassName} >
            ...
            case "2":
                switch (this.state.vars) {
                    case "1":
                        ...
                        styledToggler = [
                            <MediaQuery key={this.state.keys[0]} minWidth={1224}><div key={this.state.keys[0]} id={this.state.id} style={use.FULLELEMENT} className={this.state.className}>
                                <div style={use.CLICKBOX} onClick={this.toggle}>
                                    {this.state.first}
                                </div>
                                <div style={use.TOGGLERBOX}>
