            ...
            case "1":
                switch (this.state.vars) {
                    case "1":
                        ...
                        styledHR = [
                            <MediaQuery key={tempkeys[0]} minWidth={1224}><hr style={use.STYLES} id={this.state.id} className={this.state.className} /></MediaQuery>,
            ...
            case "1":
                switch (this.state.vars) {
                    case "1":
                        use = hrFunction("1", props, state, self)
                        styledHR = [
                            <MediaQuery key={this.state.keys[0]} minWidth={1224}><hr style={use.STYLES} id={this.state.id} className={this.state.className} /></MediaQuery>,
