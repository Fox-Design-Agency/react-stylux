...
export default class Hero2 extends Component {
    ...
    render() {
        ...
        const BOTTOMBACKGROUND = StyleSheet.create({
            bottombackground: {
        ...
        return (
            <div style={HEROSTYLE.herostyle} id={this.state.heroid} className={this.state.heroClassName}>
                <div style={BOTTOMBACKGROUND.bottombackground} id={this.state.bottomid} className={this.state.bottomClassName}>
                    <Holder
                        direction='column'>
                        {this.state.childs[0]}
                    </Holder>
