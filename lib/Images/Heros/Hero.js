    ...
    componentDidMount() {
        ...
        switch (this.state.box) {
            case "1":
                ...
                styledHero = [
                    <MediaQuery key={tempkeys[0]} query="(min-width: 1224px)"><div style={use.herostyle} id={this.state.id} className={this.state.className}>
                        <Holder
                            direction='column'>
                            {CHILDS[0]}
                            {CHILDS[2]}
            ...
            case "2":
                ...
                styledHero = [
                    <MediaQuery key={tempkeys[0]} query="(min-width: 1224px)"><div style={use.herostyle} id={this.state.heroid} className={this.state.heroClassName}>
    ...
    componentWillReceiveProps(newProps) {
        ...
        switch (this.state.box) {
            case "1":
                use = heroFunction("1", props, state, self)
                styledHero = [
                    <MediaQuery key={this.state.keys[0]} query="(min-width: 1224px)"><div style={use.herostyle} id={this.state.id} className={this.state.className}>
                        <Holder
                            direction='column'>
                            {CHILDS[0]}
                            {CHILDS[2]}
            ...
            case "2":
                use = heroFunction("2", props, state, self)
                styledHero = [
                    <MediaQuery key={this.state.keys[0]} query="(min-width: 1224px)"><div style={use.herostyle} id={this.state.heroid} className={this.state.heroClassName}>
                        <div style={use.HEROSTYLE.bottombackground}>
                            <Holder
                                direction='column'>
                                {CHILDS[0]}
