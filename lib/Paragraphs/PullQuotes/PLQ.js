...
export default class PLQ extends React.Component {
    ...
    componentDidMount() {
        ...
        if (this.state.type === "1") {
            ...
            styledPullQuote = [
                <blockquote key={Math.random()} style={use.PULLQUOTESTYLES.pullquotestyles} id={this.state.blockid} className={`pullQuote1 ${this.state.blockClassName}`} >
            ...
            styledPullQuote = [
                <blockquote key={Math.random()} style={use.PULLQUOTESTYLES.pullquotestyles} id={this.state.blockid} className={`pullQuote2 ${this.state.blockClassName}`}>
